...
class BarbersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create barber" do
    assert_difference('Barber.count') do
      post barbers_url, params: { barber: { averageRating: @barber.averageRating, barberType: @barber.barberType, charge: @barber.charge, description: @barber.description, email: @barber.email } }
    end
  ...
  test "should update barber" do
    patch barber_url(@barber), params: { barber: { averageRating: @barber.averageRating, barberType: @barber.barberType, charge: @barber.charge, description: @barber.description, email: @barber.email } }
