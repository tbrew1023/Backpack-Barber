...
class FollowsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create follow" do
    assert_difference('Follow.count') do
      post follows_url, params: { follow: { barberID_id: @follow.barberID_id, customerID_id: @follow.customerID_id } }
    end
  ...
  test "should update follow" do
    patch follow_url(@follow), params: { follow: { barberID_id: @follow.barberID_id, customerID_id: @follow.customerID_id } }
