...
class PromotionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create promotion" do
    assert_difference('Promotion.count') do
      post promotions_url, params: { promotion: { description: @promotion.description, desturl: @promotion.desturl, enddate: @promotion.enddate, imgpath: @promotion.imgpath, startdate: @promotion.startdate, title: @promotion.title } }
    end
  ...
  test "should update promotion" do
    patch promotion_url(@promotion), params: { promotion: { description: @promotion.description, desturl: @promotion.desturl, enddate: @promotion.enddate, imgpath: @promotion.imgpath, startdate: @promotion.startdate, title: @promotion.title } }
